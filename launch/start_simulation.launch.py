...
def generate_launch_description():
    ...
    bridge = Node(
        ...
        arguments=['lidar@sensor_msgs/msg/LaserScan@gz.msgs.LaserScan',
                   ...
                   'dist_sensor_0@sensor_msgs/msg/Range@gz.msgs.LaserScan',
                   'dist_sensor_1@sensor_msgs/msg/Range@gz.msgs.LaserScan',
                   'dist_sensor_2@sensor_msgs/msg/Range@gz.msgs.LaserScan',
                   'dist_sensor_3@sensor_msgs/msg/Range@gz.msgs.LaserScan',
                   'dist_sensor_4@sensor_msgs/msg/Range@gz.msgs.LaserScan',
                   'dist_sensor_5@sensor_msgs/msg/Range@gz.msgs.LaserScan',
                   'dist_sensor_6@sensor_msgs/msg/Range@gz.msgs.LaserScan',
                   'dist_sensor_7@sensor_msgs/msg/Range@gz.msgs.LaserScan',
                   'dist_sensor_8@sensor_msgs/msg/Range@gz.msgs.LaserScan'],
        output='screen'
    )
